...
export async function getProducts(locale: string,type?: string, limit?: number, offset?: number) {
...
export async function sendEmail(data: any) {
    ...
    await fetch('https://projectshopapi.pythonanywhere.com/api/v1/send_mail/', {
        method: "POST",
        headers: {
